...
const initCarrito = (products) => {
    ...
    carrito =  new Carrito(products.currency)
    ...
    products.products.forEach(producto => {
        ...
        newProductElement.querySelector('.prodName').textContent = unProducto.title
        newProductElement.querySelector('.prodReference').textContent = `Ref: ${unProducto.SKU}`
        newProductElement.querySelector('.productQuantity').value = 0
        newProductElement.querySelector('.prodPrice').textContent = unProducto.price + products.currency
        newProductElement.querySelector('.prodSubtotal').textContent = '0' + products.currency
